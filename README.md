...
| Qwen 3.8 -- 27B NVFP4 | Alibaba | NVIDIA | [`vllm-qwen-3.8-27b-nvfp4/`](vllm-qwen-3.8-27b-nvfp4/) | [nvidia/Qwen3.8-27B-NVFP4](https://huggingface.co/nvidia/Qwen3.8-27B-NVFP4) | `nvidia/Qwen3.8-27B-NVFP4` on vLLM (ModelOpt) |
...
bash run.sh [qwen|muse|sglang|nemotron|gemma4] [test]  # benchmark suite (8 tests x 3 iterations)
